        		...
        		return(
        			React.createElement("div", {className: "personal"}, 
        				React.createElement("form", null, 
	        				React.createElement("p", {className: "username"}, 
	        					React.createElement("label", null, "昵称："), React.createElement("input", {type: "text", name: "username", placeholder: "请输入昵称", onChange: this.handleUserNameChange, value: _this.state.username})
	        				), 
	        				React.createElement("div", {className: "select-box"}, 
	        					React.createElement("label", null, "职位："), 
					        	React.createElement("div", {className: "select-copy clearfix"}, 
						           	React.createElement("div", {className: "content arrow-bottom-btn", onClick: _this.contentClick}, 
	        				...
	        				React.createElement("p", {className: "place", value: _this.state.place}, 
	        					React.createElement("label", null, "地址："), " ", React.createElement("input", {type: "text", name: "city", className: "city", placeholder: "请输入地址", onChange: this.handleAddressChange, value: _this.state.city})	
	        				), 
	        				React.createElement("div", {className: "sex clearfix"}, 
		        				React.createElement("label", null, "性别："), " ", 
		        				React.createElement("div", {className: "sex-input"}, 
	        				...
	        				React.createElement("p", {className: "sign"}, 
			        			React.createElement("label", null, "个性签名："), 
					...
					React.createElement("div", {className: "head"}, 
						React.createElement("form", {className: "uploadForm", enctype: "multipart/form-data", action: "/user/updateLogo", method: "post", target: "uploadIframe"}, 
							...
							React.createElement("div", {className: "user"}, 
								React.createElement("img", {src: _this.state.logoDir+'?'+Math.random()*1000}), 
	            ...
	            return (
	            	React.createElement("div", null, 
		            	...
		            	React.createElement("div", {className: "settings clearfix"}, 
			                ...
			                React.createElement("h3", {className: "title"}, React.createElement("i", {className: "fa fa-cogs"}), "设置"), 
