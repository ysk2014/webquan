        		...
        		return(
        			React.createElement("div", {className: "personal"}, 
        				React.createElement("form", null, 
	        				...
	        				React.createElement("p", null, 
	        					"职位：  ", React.createElement("select", {name: "job", className: "job", onChange: this.handlePositionChange}, 
			...
			render: function(){
				return(
					React.createElement("div", {className: "email-box"}, 
						...
						React.createElement("p", {className: "sec"}, "2409551912@.com"), 
...
// 密码修改
		var ModifyPassword = React.createClass({displayName: "ModifyPassword",
			...
			render: function(){
				return(
					React.createElement("form", {className: "modify-psd"}, 
        ...
        return React.createClass({
	        ...
	        judge :function(){
	        	...
	        	switch(_this.state.nav){
	        		...
	        		case "email": return React.createElement(Email, null);
	        		case "modify":return React.createElement(ModifyPassword, null);
	        	}
	        },
	        render: function() {
	        	var _this = this;
