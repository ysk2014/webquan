				...
				React.createElement("div", null, 
					...
					React.createElement("div", {className: "cloumn-page"}, 
						React.createElement("div", {className: "cloumn-header"}, 
							React.createElement("div", {className: "cname"}, _this.state.cloumn['name'] ? _this.state.cloumn['name'] : ''), 
							React.createElement("div", {className: "cdesc"}, _this.state.cloumn['description'] ? _this.state.cloumn['name'] : '')
						)
					)
				)
			);
