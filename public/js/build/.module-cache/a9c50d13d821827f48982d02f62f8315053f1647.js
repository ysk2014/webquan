						...
						React.createElement("div", {className: "comment-box"}, 
							...
							React.createElement("div", {className: "bd"}, 
								...
								React.createElement("div", {className: "comment-list"}, 
									commentList, 
									React.createElement("a", {className: "more", style: _this.state.next ? {display:'block'} : {display:'none'}, "data-page":  _this.state.page ? _this.state.more[nav] : 1, onClick: _this.hamdleMore}, "更多评论")
								)
							)
						)
					)
