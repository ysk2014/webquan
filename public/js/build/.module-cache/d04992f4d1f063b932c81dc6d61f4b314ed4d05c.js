	...
	return React.createClass({
		...
		getInitialState: function() {
			return {
				...
				logo_dir: '/upload_path/cloumn-logo/web5.jpg'
			}
		},
			...
			return (
				React.createElement("div", null, 
					...
					React.createElement("div", {className: "cloumn-edit"}, 
						React.createElement("form", {className: "uploadForm", action: "/cloumn/updateLogo", method: "post", target: "uploadIframe"}, 
							...
							React.createElement("div", {className: "upload"}, 
								...
								React.createElement("i", {className: "fa fa-picture-o", onClick: this.handleUploadClick, style: _this.state.logo_dir !='' ? {display:'none'} : {display:'block'}}), 
								React.createElement("img", {className: "preview", src: _this.state.logo_dir, on: true}), 
