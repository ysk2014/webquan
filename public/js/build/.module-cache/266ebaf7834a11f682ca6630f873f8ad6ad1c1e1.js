					...
					React.createElement("div", {className: "edit-article"}, 
						React.createElement("form", null, 
				            ...
				            React.createElement("div", {className: "tags-list", onClick: _this.getFocus}, 
				            	...
				            	React.createElement("ul", {onFocus: _this.handleFocusTags}, tags, React.createElement("li", {style: _this.state.cacheTags.length>4 ? {display:'none'} : {display:'block'}}, React.createElement("a", null, "创建标签")))
				            ), 
