			...
			render: function(){
				...
				return(
					React.createElement("div", {className: "head"}, 
						React.createElement("form", {action: "/user/updateLogo", method: "post", enctype: "multipart/form-data"}, 
							...
							React.createElement("input", {type: "file", name: "logo-image-file", id: "logo-image-file", style: {display:'none'}, value: _this.state.url, onChange: _this.handleFileChange}), 
