				...
				React.createElement("div", null, 
					...
					React.createElement("div", {className: "cloumn-page"}, 
						React.createElement("div", {className: "cloumn-header"}, 
							React.createElement("div", {className: "cname"}, React.createElement("h3", null, _this.state.cloumn['name'] ? _this.state.cloumn['name'] : '')), 
							React.createElement("div", {className: "anthor"}, React.createElement("i", {className: "fa fa-user"}), "所有者：", _this.state.cloumn['username'] ? _this.state.cloumn['username'] : ''), 
