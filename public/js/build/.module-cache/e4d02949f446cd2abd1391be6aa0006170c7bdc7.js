			...
			return (
				React.createElement("div", null, 
					...
					React.createElement("div", {className: "header"}, 
						...
						React.createElement("a", {className: true})
					), 

					React.createElement("div", {className: "cloumn-list"}, 
						React.createElement("ul", {className: "orderBy-nav"}, 
							React.createElement("li", {className: "active"}, React.createElement("a", null, "热门排序")), 
							React.createElement("li", {className: ""}, React.createElement("a", null, "最近更新")), 
							React.createElement("li", {className: ""}, React.createElement("a", null, "关注度排序"))
						)
					)
				)
			);
