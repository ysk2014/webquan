				...
				return(
					React.createElement("div", {className: "head"}, 
						React.createElement("div", {className: "user", style: {background:'url("'+_this.state.logoDir+'") no-repeat center'}}), 
							"// ", React.createElement("form", {enctype: "multipart/form-data", action: "/user/updateLogo", method: "post", target: "uploadIframe"}, 
														
							"//  ", React.createElement("iframe", {name: "uploadIframe", id: "uploadIframe", style: "display:none"}), 

							"//  ", React.createElement("input", {type: "text", name: "id", style: "display:none", value: true}), 
							...
							"//  ", React.createElement("a", {className: "submit-button"}, "上传头像"), 
							"// ")
