			...
			return (
				React.createElement("div", null, 
					...
					React.createElement("div", {className: "cloumn-edit"}, 
						React.createElement("form", {action: "/cloumn/updateLogo", method: "post", target: "uploadIframe"}, 
							React.createElement("h3", null, _this.state.cid>0 ? '编辑' : '新建', "专题"), 
							React.createElement("div", {className: "upload"}, 
								React.createElement("input", {type: "file", name: "cloumn-image", style: {display:'none'}, onChange: _this.state}), 
