						...
						React.createElement("div", {className: "desc"}, 
							...
							React.createElement("div", {className: "author"}, 
								...
								React.createElement("span", {className: "tag"}, " 评论: ", d.comment), 
									d.tags ? 
									(React.createElement("span", {className: "tag"}, " ", React.createElement("i", {className: "fa fa-tags"}), "  ", d.tags.indexOf('|')>0)) : null, 
								
								React.createElement("span", {className: "tag"}, " ", React.createElement("i", {className: "fa fa-tags"}), " ", d.tags)
							), 
