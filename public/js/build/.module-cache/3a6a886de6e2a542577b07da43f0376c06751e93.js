				...
				return(
					React.createElement("div", {className: "head"}, 
						React.createElement("form", {className: "uploadForm", enctype: "multipart/form-data", action: "/user/updateLogo", method: "post", target: "uploadIframe"}, 
							...
							React.createElement("div", {className: "user", style: {background:'url("'+_this.state.logoDir+'") no-repeat center',backgroundSize:'cover'}}, 
								React.createElement("img", {src: _this.state.logoDir}), 
