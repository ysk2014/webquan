	...
	return React.createClass({
		...
		render: function() {
			...
			var list = (this.state.list[nav] && this.state.list[nav].length>0) ? this.state.list[nav].map(function(d,i) {
				var tagsList = d.tags ? (d.tags.indexOf('|') ? d.tags.split('|').map(function(t,k) {
					return (React.createElement("a", {style: {marginRight:'6px'}, href: "javascript:void(0)"}, t));
				}) : (React.createElement("a", {href: "javascript:void(0)"}, "d.tags"))) : null;
				return (
					React.createElement("article", {key: d.id}, 
						...
						React.createElement("div", {className: "desc"}, 
							...
							React.createElement("div", {className: "author"}, 
								...
								React.createElement("span", {className: "tag"}, " ", React.createElement("i", {className: "fa fa-tags"}), " ", tagsList)
							), 
