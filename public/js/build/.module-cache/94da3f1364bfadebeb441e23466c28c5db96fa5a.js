					...
					React.createElement("li", {key: d.id, "data-cid": d.id, "data-key": i, className: "cloumn"}, 
						React.createElement("a", {href: "/cloumn/"+d.id}, 
							...
							React.createElement("p", null, 
								...
								React.createElement("a", {className: "btn-success", "data-care": d.myCare ? d.myCare : false, onClick: _this.handleCare, onMouseEnter: _this.handleOver, onMouseOut: _this.handleOut}, d.myCare ? '正在' : '添加', "关注")
							)
						)
					)
				);
