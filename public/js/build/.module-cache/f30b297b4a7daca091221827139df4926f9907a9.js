	            	...
	            	React.createElement("div", null, 
		            	...
		            	React.createElement("div", {className: "settings clearfix"}, 
			                ...
			                React.createElement("div", {className: "con"}, 
			                	React.createElement(Personal, {style: _this.state.nav=='personal' ? {display:'block'} : {display:'none'}}), 
			                	React.createElement(Head, {style: _this.state.nav=='personal' ? {display:'block'} : {display:'none'}}), 
			                	React.createElement(Email, {style: _this.state.nav=='personal' ? {display:'block'} : {display:'none'}}), 
			                	React.createElement(ModifyPassword, {style: _this.state.nav=='personal' ? {display:'block'} : {display:'none'}})
			                )
		                )
	                )
