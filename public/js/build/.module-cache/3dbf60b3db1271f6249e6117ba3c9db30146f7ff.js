				...
				React.createElement("div", null, 
					...
					React.createElement("div", {className: "header"}, 
						React.createElement("div", {className: "btn-list"}, 
							React.createElement("a", {className: "btn", href: "/article/edit/"+this.state.aid, "data-placement": "bottom", "data-title": "编辑文章"}, 
								React.createElement("i", {className: "fa fa-pencil-square-o"})
							), 
							React.createElement("a", {className: "btn", "data-placement": "bottom", "data-title": "收藏文章"}, 
								React.createElement("i", {className: "fa fa-bookmark-o"})
							), 
							React.createElement("a", {className: "btn", "data-placement": "bottom", "data-title": "分享文章"}, 
					...
					React.createElement("div", {className: "article-page", style: _this.state.info ? {display:'block'} : {display: 'none'}}, 
						...
						React.createElement("div", {style: {marginBottom:'10px'}}, 
							React.createElement("a", {className: "btn-success", href: "/article/edit/"+this.state.aid}, 
								React.createElement("i", {className: "fa fa-pencil-square-o", style: {marginRight:'8px'}}), 
								React.createElement("span", null, "编辑文章")
							)
						), 
