		...
		render: function() {
			...
			if(nav==0) {
				var articles = _this.state.cloumns.map(function(d,i) {
					return (
						React.createElement("div", {className: "cloumn"}, 
							...
							React.createElement("div", {className: "cloumn-info"}, 
								...
								React.createElement("p", null, React.createElement("a", {href: "/cloumn/"+d.id}, d.count+'篇文章'), React.createElement("span", null, "· 34.7K人关注"))
							)
						)
					);
				});
