    ...
    'home/common/userDropMenu',
		...
		var Head = React.createClass({displayName: "Head",
			...
			componentDidUpdate: function() {
				...
				// 			<a className="submit-button">上传头像</a>
				// 		</form>';
				// $('.head').append()
			},
			render: function(){
				...
				return(
					React.createElement("div", {className: "head"}, 
						...
						React.createElement("form", {className: "upload", enctype: "multipart/form-data", action: "/user/updateLogo", method: "post", target: "uploadIframe"}, 
