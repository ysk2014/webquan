define([
	...
	var mixin = {
		...
		handleCare: function(event) {
			...
			var myCare = $(event.target).attr('care');
					...
					React.createElement("li", {key: d.id, "data-cid": d.id, "data-key": i, className: "cloumn"}, 
						React.createElement("a", {href: "/cloumn/"+d.id}, 
							...
							React.createElement("p", null, 
								...
								React.createElement("a", {className: "btn-success", care: d.myCare ? d.myCare : false, onClick: _this.handleCare, onMouseEnter: _this.handleOver, onMouseLeave: _this.handleOut}, d.myCare ? '正在关注' : '添加关注')
							)
						)
					)
				);
