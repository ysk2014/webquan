	...
	var mixin = {
		...
		showEditor: function(){
	        ...
	        var testEditor = editormd("article-editormd", {
                ...
                imageUploadURL : "/user/updateLogo",
		...
		render: function() {
			...
			if(this.state.cloumns.length>0) {
				var cloumns = _this.state.cloumns.map(function(d,i) {
					return (React.createElement("span", {key: d.id, "data-cid": d.id, className: (_this.state.selected===d.id) ? "tag selected" : "tag", onClick: this.handleSelect.bind(this,i)}, d.title));
				}.bind(this));
			} else {
				var cloumns = null;
			}
			...
			return (
				React.createElement("div", null, 
					...
					React.createElement("div", {className: "header"}, 
						React.createElement("span", {className: "desc"}, "发布文章"), 
