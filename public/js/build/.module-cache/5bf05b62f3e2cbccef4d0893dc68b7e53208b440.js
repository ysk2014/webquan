...
requirejs([
    ...
    ],function(React, ReactRouter, Home, Login, User, EditArticle, Article, Settings, CloumnList, EditCloumn){
    ...
    var routes = (
        React.createElement(Route, {handler: App}, 
            ...
            React.createElement(Route, {path: "/cloumn/:id", handler: EditCloumn}), 
