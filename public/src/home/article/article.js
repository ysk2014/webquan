		...
		render: function() {
			...
			var commentList = this.state.commentList.length>0 ? this.state.commentList.map(function(d,i) {
				...
				var children = d['children'] ? d['children'].map(function(m,n) {
					...
					return (
						<div key={n} id={"comment-"+m.id} className="children-item" data-id={m.id}>
							<div className="con">
							...
							<div className="replay" data-nick={m.username} data-index={i} data-uid={m.uid} data-fid={d.id} data-id={m.id} data-key={n} data-pid={m.pid}>
				...
				return (
					<div key={i} id={"comment-"+d.id} className="comment-item  clearfix" data-id={d.id}>
						...
						<div className="comment-right">
							...
							<div className="replay" data-nick={d.username} data-index={i} data-uid={d.uid} data-fid={d.fid} data-pid={d.pid} data-id={d.id} data-key={i}>
								<a onClick={_this.handleReplay}>回复</a>
								{
