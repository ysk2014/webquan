...
<head>
	...
	<![endif]-->
	<script data-main="{{ asset('js/app.js') }}" src="{{ asset('js/lib/require.js') }}"></script>
</head>
<body>
	...
	<div class="fixed-btn">
		<a class="go-top hide-go-top" href="javascript:void(0)"><i class="icon-angle-up"></i></a>
		<a class="writer" href="" data-toggle="tooltip" data-placement="left" data-title="写篇文章"><i class="icon-pencil"></i></a>
	</div>
      ...
      <div class="wrapper">
        <div class="module">
          <div style="font-size:12px;line-height:20px;">
          	Power By NodeJS，本站所有代码的地址在
          	<a href="https://github.com/xinyu198736/htmljs" target="_blank">这里</a>  
          	浙ICP备12047043号  
          	<a href="/friendlink">友情链接</a>  
          	<a href="https://f2e.souche.com/blog" target="_blank">大搜车前端团队博客</a>
          </div>
        </div>
      </div>
    </footer> -->
